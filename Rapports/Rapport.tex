...
\begin{document}
	...
	\chapter{TP3}
		...
		\section{Question 7}
			...
			\lstinputlisting[caption=PluginEdges\_.java]{../src/main/java/PluginKind_.java}
			
			Ce plugin permet de définir si une image représente la mer ou le ciel (ou les deux).
			
			Pour ce faire, on commence par découper l'image en 100 cases de taille égale. Puis nous appliquons le traitement suivant sur chaque case :
			\begin{easylist}
