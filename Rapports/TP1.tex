...
\begin{document}
	...
	\chapter{Questions}
		...
		\section{Question 4}
			L'image \cbo{soleil} est celle ayant le plus changé car est est à l'origine extrêmement sombre (très peu de contraste, c'est a dire très peu de niveaux de gris utilisés). L'égalisation du contraste fait beaucoup varier la couleur des pixels qui étaient à l'origine très proches.
